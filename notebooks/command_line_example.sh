...
wot gene_set_scores --matrix data/ExprMatrix.loom \
--method mean_z_score \
--gene_sets data/gene_sets.gmx

# Compute transport maps
wot optimal_transport --matrix data/ExprMatrix.var.genes.loom \
...
wot trajectory --tmap tmaps/serum \
...
wot trajectory_divergence --trajectory wot_trajectory.txt \
--cell_days data/cell_days.txt \
...
wot trajectory_trends --trajectory wot_trajectory.txt \
--cell_days data/cell_days.txt \
...
wot diff_exp --matrix data/ExprMatrix.loom \
--cell_days data/cell_days.txt \
--trajectory wot_trajectory.txt \
--verbose

# Compute and plot validation summary
wot optimal_transport_validation --matrix data/ExprMatrix.var.genes.loom \
--cell_days data/cell_days.txt \
--covariate data/batch.txt
