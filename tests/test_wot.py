    ...
    def test_ot_commmand_line_clusters_subsample(self):
        subprocess.call(args=['python', os.path.abspath('../bin/ot.py'),
                ...
                '../paper/pairs_2i.txt'),
                              ...
                              '--subsample_cells', '4000',
                              '--subsample_cells', '3000',
                              '--subsample_cells', '2500',
    ...
    def test_trajectory(self):
        ...
        for i in range(0, len(ncells) - 1):
            ...
            transport_maps.append({'transport_map': transport_map,
                                   't_minus_1': i, 't': i + 1})
        trajectory_id = ['c4-t3']
        result = wot.trajectory(trajectory_id, transport_maps, 3, False)
        ...
        trajectory_id = ['c1-t1']
        result = wot.trajectory(trajectory_id, transport_maps, 1, False)
